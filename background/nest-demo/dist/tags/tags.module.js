...
const tags_providers_1 = require("./tags.providers");
...
exports.TagsModule = TagsModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [tags_service_1.TagsService, ...tags_providers_1.tagsProviders],
        controllers: [tags_controller_1.TagsController],
        providers: [tags_service_1.TagsService, ...tags_providers_1.tagsProviders],
    })
], TagsModule);
